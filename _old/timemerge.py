...
file1_name = 'eventresult_71535628.csv'
file2_name = 'eventresult_71535629.csv'

# Construct the full paths to the files
file1_path = os.path.join(script_directory, file1_name)
file2_path = os.path.join(script_directory, file2_name)

# Skip metadata rows and load the data
df_split1 = pd.read_csv(file1_path, skiprows=3)
df_split2 = pd.read_csv(file2_path, skiprows=3)

# Combine the two DataFrames
df_combined = pd.concat([df_split1, df_split2])
