...
def read_json(uri, payload):
    with open(uri, "r") as write_file:
...
if __name__ == '__main__':
    ...
    with open("series_419_s3_ids.txt") as file:
        for item in file:
            result = idc.result(subsession_id=item)
            results_file = './results/series_419_s3_' + str(int(item)) + '.json'
